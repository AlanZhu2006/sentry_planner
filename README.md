...
Supported values are `infantry`, `hero`, `sentry`, and `damiao`. When this file exists, `just build` and `just flash` use it by default, and passing a different robot value fails fast.
