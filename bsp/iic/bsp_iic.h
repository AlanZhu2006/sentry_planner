...
#define IIC_DEVICE_CNT 1   // OmniCtrl Pro 2 exposes I2C4 to the BSP.
#define MX_IIC_SLAVE_CNT 8 // Maximum number of registered slaves.
...
typedef enum
{
    IIC_SEQ_RELEASE, // Release the bus after the transfer.
    IIC_SEQ_HOLDON,  // Keep the bus for a following IT/DMA transfer.
} IIC_Seq_Mode_e;
