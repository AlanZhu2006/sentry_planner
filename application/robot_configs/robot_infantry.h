...
#define YAW_CHASSIS_ALIGN_ECD                                                  \
  2183 // 云台和底盘对齐指向相同方向时的电机编码器值,若对云台有机械改动需要修改
...
#define PITCH_MAX_ANGLE                                                        \
  18.0f // 云台竖直方向最大角度 (注意反馈如果是陀螺仪，则填写陀螺仪的角度) -
        // 向上抬头
#define PITCH_MIN_ANGLE                                                        \
  -11.0f // 云台竖直方向最小角度 (注意反馈如果是陀螺仪，则填写陀螺仪的角度) -
         // 向下低头
...
#define REDUCTION_RATIO_LOADER                                                 \
  36.0f // infantry 拨盘使用 M2006, 减速比为 36.0f
...
// PID参数 - 底盘
#define CHASSIS_SPEED_PID_KP 15.0f
...
// PID参数 - 云台
#define GIMBAL_YAW_ANGLE_PID_KP 28.0f
#define GIMBAL_YAW_ANGLE_PID_KI 0.0f
#define GIMBAL_YAW_ANGLE_PID_KD 1.3f
#define GIMBAL_YAW_ANGLE_PID_DEADBAND 0.008f
#define GIMBAL_YAW_ANGLE_PID_INT_LIMIT 100.0f
#define GIMBAL_YAW_ANGLE_PID_MAX_OUT 2200.0f
#define GIMBAL_YAW_SPEED_PID_KP 150.0f
#define GIMBAL_YAW_SPEED_PID_KI 135.0f
#define GIMBAL_YAW_SPEED_PID_KD 0.0f
#define GIMBAL_YAW_SPEED_PID_INT_LIMIT 4000.0f
#define GIMBAL_YAW_SPEED_PID_MAX_OUT 26000.0f

#define GIMBAL_PITCH_ANGLE_PID_KP 22.0f
#define GIMBAL_PITCH_ANGLE_PID_KI 0.0f
#define GIMBAL_PITCH_ANGLE_PID_KD 1.1f
#define GIMBAL_PITCH_ANGLE_PID_DEADBAND 0.020f
#define GIMBAL_PITCH_ANGLE_PID_INT_LIMIT 100.0f
#define GIMBAL_PITCH_ANGLE_PID_MAX_OUT 950.0f

#define GIMBAL_PITCH_SPEED_PID_KP 85.0f
#define GIMBAL_PITCH_SPEED_PID_KI 18.0f
#define GIMBAL_PITCH_SPEED_PID_KD 6.0f
#define GIMBAL_PITCH_SPEED_PID_DEADBAND 0.0f
#define GIMBAL_PITCH_SPEED_PID_INT_LIMIT 1800.0f
#define GIMBAL_PITCH_SPEED_PID_MAX_OUT 26000.0f
#define GIMBAL_PITCH_PID_USE_DERIVATIVE_FILTER 1
#define GIMBAL_PITCH_ANGLE_DERIVATIVE_LPF_RC 0.018f
#define GIMBAL_PITCH_SPEED_DERIVATIVE_LPF_RC 0.015f

// 视觉链路跟随参数
#define VISION_YAW_MAX_SLEW_DEG_S GIMBAL_YAW_ANGLE_PID_MAX_OUT
#define VISION_PITCH_MAX_SLEW_DEG_S GIMBAL_PITCH_ANGLE_PID_MAX_OUT
#define VISION_TARGET_ACC_FILTER_ALPHA 0.35f
#define VISION_VEL_LEAD_TIME_S 0.040f
#define VISION_USE_ACCEL_LEAD 1

// yaw 速度前馈
#define GIMBAL_YAW_SPEED_FEEDFORWARD_ENABLE 1
#define GIMBAL_YAW_SPEED_FEEDFORWARD_GAIN 0.85f
#define GIMBAL_YAW_SPEED_FEEDFORWARD_LPF_ALPHA 0.40f
#define GIMBAL_YAW_SPEED_FEEDFORWARD_MAX_DEG_S 650.0f
