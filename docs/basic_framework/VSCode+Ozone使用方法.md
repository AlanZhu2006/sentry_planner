...
> Legacy upstream framework documentation. The current `nyush-rm-control` workspace uses `just -> Makefile` for build/flash and no longer uses the OpenOCD / Cortex-Debug workflow described in parts of this document.
